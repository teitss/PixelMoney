...
public class Group {
    ...
    public Group(int id, double money, boolean isLevelBased, String operationType, boolean isBossRewardEnable,
                 double equalBossReward, double uncommonBossReward, double rareBossReward, double legendaryBossReward,
                 double ultimateBossReward, boolean isNpcRewardEnabled, String logMessage,
